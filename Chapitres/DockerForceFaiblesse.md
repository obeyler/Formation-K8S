...
Comme la formation n'est pas dédiée à Docker (ni aux machines virtuelles), mais à Kubernetes.
...
Cela est dû au fait que Docker va se reposer sur l'hôte pour une bonne partie de son execution.
...
La gestion de ses mapping de ports qui peut paraître simple au début, va poser des problèmes sur le long terme.
